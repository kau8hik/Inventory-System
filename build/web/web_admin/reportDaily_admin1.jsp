...
<%@page import="com.Product.ProductEntry.p_reportDaily"%>
...
session.setMaxInactiveInterval(15*60);
  ...
  if(uname==null){
    session.setAttribute("from_page", "reportDaily_admin1.jsp");
 ...
 <link href="style1.css" rel="stylesheet" type="text/css" />
    ...
    <div id="divBanner" style="padding: 0 15px 0 30px;">
        ...
        <%
            ...
            p_reportDaily prd=new p_reportDaily();
            prd.getData();
            //out.println(result);
            String filepath = "C:\\Reports_Daily\\";
