...
session.setMaxInactiveInterval(15*60);
  ...
  if(uname==null){
    session.setAttribute("from_page", "reportMonthly_admin.jsp");
	...
	<div id="topNav" class="list">
             ...
             <ul>
                ...
                <li><a href="bringstock_admin.jsp">Stock</a>
                    <ul>
                        <li><a href="stockViewv.jsp"  class="headerLinks">Stock View</a></li>
                ...
                <li><a href="#"  >Credits</a>
                    <ul>
                        ...
                        <li><a href="credit_show.jsp"  class="headerLinks"> Show Credits</a></li>
                    </ul>
                </li>

                <li><a href="stockadd_admin.jsp"  >Add New Product</a>
                    <ul>
                        <li><a href="stockaddv.jsp"  class="headerLinks"> Add New Product</a></li>
            ...
            <table width="100%" style="height:500px"   border="1">
                <tr>
                    <td width="70%" align="center" valign="top" >
                        <br><br>
                        <form action="reportMonthly_admin1.jsp" method="POST">
                            <input type="Submit" value="Get Monthlys Report"/><br/>
                        </form>
