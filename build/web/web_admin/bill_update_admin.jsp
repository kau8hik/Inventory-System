    ...
    <body>
        ...
        <%
         ...
         try {
            ...
            int total = 0;
            String a=new String();
            String table=new String();String table_in=new String();
            switch(bill_id){
                case 1: table="temp";table_in="stock";break;
                case 2: table="temp_bill2";table_in="stock";break;
                case 3: table="temp_bill3";table_in="stock";break;
                case 4: table="temp_bill4";table_in="p_stock";break;
                case 5: table="temp_bill5";table_in="p_stock";break;
            }
         ...
         switch(bill_id){
            ...
            if(noofbottles1.equals("0")){
               ...
               switch(bill_id){
                    ...
                    String Query = "Select * from "+table_in+" where barcode =" + barcode;
