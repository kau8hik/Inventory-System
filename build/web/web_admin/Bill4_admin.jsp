...
session.setAttribute("bill_id", 4);
  String uname= (String) session.getAttribute("uname");
  if(uname==null){
    session.setAttribute("from_page", "Bill4_admin.jsp");
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="topNav" class="list">
        ...
        Logged in as : <%=uname%>                                       Bill4                                              <a href="../logout.jsp">Logout</a></pre>
        <table width="100%"  border=1>
            <tr>
                <td rowspan="1" width="10%" height="222px"><pre><br>
                <form name="input" action="Bill4_admin.jsp" method="post" onsubmit="return validateForm();">
               ...
               <input type="submit" value="submit"/>
                ...
                try {
                        ...
                        if (a == null) {
                            ...
                            int noofbottles = 1;
                            //out.println(id);
                            String Query = "Select * from p_stock where barcode =" + id;
                            //out.println(Query);
                            //out.println(Query);
                            ...
                            String query12 = "SELECT SUM( Litres ) AS t FROM temp_bill4";
                    ...
                    <%
                            ...
                            String Query_ret_temp = "Select * from temp_bill4 where barcode =" + id;
                            ...
                            if (category_ret_temp == null) {
                                String Query1 = "insert into temp_bill4 values(" + id + ",'" + Category + "','" + Brand + "','" + Product + "'," + Volume + "," + noofbottles + "," + Price + ","+ind_volume+","+ind_price+")";
                                psmt = con.prepareStatement(Query1);
                                psmt.execute();
                            }
                            else {
                                String Query1_update_tmp = "update temp_bill4 set price=price+" + ind_price + ",litres=litres+" + ind_volume + ",noofbottles=noofbottles+" + noofbottles + " where barcode=" + id;
                ...
                //out.println(Query1);
                //out.println(res1);
                String Query2 = "Select * from temp_bill4 ";
                //out.println(Query);
                //out.println(Query2);
                psmt3 = con.prepareStatement(Query2);
                res3 = psmt3.executeQuery();

                String Query_total = "SELECT sum( Price ) as t FROM temp_bill4";
