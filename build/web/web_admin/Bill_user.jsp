...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="topNav" class="list">
             ...
             <ul>
                ...
                <li><a href="bringstock.jsp">Stock</a>
                    <ul>
                ...
                <li><a href="stockadd.html"  >Add New Product</a>
                    <ul>
        ...
        <table width="100%"  border=1>
            <tr>
                <td rowspan="2" width="30%" height="222px"><pre><br>
            ...
            %>
                ...
                <td width="14%" height="222px">
                    <div align="center">Credit  :
                        ...
                        {
                             window.location = page.value+".html";
                         }
                       </script>
                    </div>
                </td>
