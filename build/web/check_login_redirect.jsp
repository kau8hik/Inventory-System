    ...
    <body>
         <%
            ...
            if(uname.equals(uname_db) && password.equals(password_db)){
               ...
               if(from_page==null){
                   if(admin_db==1)   response.sendRedirect("web_admin/Bill_admin.jsp");
                   else response.sendRedirect("web_user/Bill_admin.jsp");
                   }
                else{
                    if(admin_db==1) response.sendRedirect("web_admin/"+from_page);
                    else response.sendRedirect("web_user/"+from_page);
                    }
            }
            else{
                %>
                <script>
                    ...
                    window.location = "take_login.jsp";
                </script>
            <%}
