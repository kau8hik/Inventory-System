...
session.setMaxInactiveInterval(15*60);
  ...
  if(uname==null){
    session.setAttribute("from_page", "sho_permitno_contents_user.jsp");
            ...
            <table width="100%" style="height:500px"   border="1">
                <tr>
                    <td width="70%" align="center" valign="top" >
                        <br><br>
                        <form name="input" action="show_permitno_contents_user1.jsp" method="post" onsubmit="return validateForm();">
