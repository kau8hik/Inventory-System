...
session.setMaxInactiveInterval(15*60);
  ...
  if(uname==null){
    session.setAttribute("from_page", "bringstock_user.jsp");
                    ...
                    <td width="70%" align="center" valign="top" >
                        <br><br>
                         ...
                         try
                         {
                            ...
                            Query = "SELECT max_stock-numberofbottles as bring,Price*(max_stock-numberofbottles) as cost, Category, Brand,price, ProductName, Litres FROM stock where numberofbottles<min_stock";
