...
session.setMaxInactiveInterval(15*60);
  ...
  if(uname==null){
    session.setAttribute("from_page", "billdelete_user1.jsp");
...
catch (Exception ex)
{
        ...
        try{
          ...
          <%
            ...
            String Query="Select contents from billingtable where billid ="+billid;
            ...
            int bar=0;int noofbot=5;
            for(int i=0;i<s_len/6;i++){
                barcode=s[bar];bar+=6;
                noofbottles=Integer.parseInt(s[noofbot]);noofbot+=6;
            ...
            psmt.executeUpdate();
            response.sendRedirect("billdelete_user.jsp");
        }
            

    }catch(Exception e){out.println(e.getMessage());}
        %>
    <form name="input" action="billdelete_user.jsp" method="post" onsubmit="return validateForm();">
