...
session.setMaxInactiveInterval(15*60);
  ...
  if(uname==null){
    ...
    response.sendRedirect("take_login_user.jsp");
  }
    try {
	...
	<div id="topNav" class="list">
             ...
             <ul>
                ...
                <li><a href="Bill_user.jsp">Billing </a>
                    <ul>
                        <li><a href="billdelete_user.html"  class="headerLinks">Delete Bill</a></li>
                        <li><a href="getbillcontents_user.html"  class="headerLinks">Bill Contents</a></li>
                    </ul>
                </li>

                <li><a href="bringstock_user.jsp">Stock</a>
                    <ul>
                        <li><a href="stockView_user.html"  class="headerLinks">Stock View</a></li>
                        ...
                        <li><a href="show_permitno_contents_user.html"  class="headerLinks"> Show Permit no Contents</a></li>
                    </ul>
                </li>

                <li><a href="Report_user.jsp"  >Reports</a>
                    <ul>
                        <li><a href="reportDaily_user.html"  class="headerLinks"> Report Daily</a></li>
                        <li><a href="reportMonthly_user.html"  class="headerLinks"> Report Monthly</a></li>
                    </ul>
                </li>

                <li><a href="#"  >Credits</a>
                    <ul>
                        <li><a href="credit_add_user.html"  class="headerLinks"> Add to credit</a></li>
                        <li><a href="credit_show_user.jsp"  class="headerLinks"> Show Credits</a></li>
                    </ul>
                </li>

                <li><a href="stockadd_user.html"  >Add New Product</a>
                    <ul>
                        <li><a href="stockadd_user.html"  class="headerLinks"> Add New Product</a></li>
                        <li><a href="product_update_user.html"  class="headerLinks"> Product Update</a></li>
                    </ul>
                </li>
