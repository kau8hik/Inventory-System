...
session.setMaxInactiveInterval(15*60);
  ...
  if(uname==null){
    session.setAttribute("from_page", "billcontent_del_user.jsp");
	...
	<div id="topNav" class="list">
        ...
        <table width="100%"  border=1>
            <tr>
                ...
                <form name="input" action="Bill_user.jsp" method="post" onsubmit="return validateForm();">
        ...
        <input type="text" autofocus size="10" name ="id"/>  <input type="text" size="10" name="noofbottles"/>
            ...
            <tr>
                ...
                <td width="30%" height="222px">
                    <pre><br>
<form name="del" action="billcontent_del_user.jsp" onsubmit="return validateForm1();" method="post">
