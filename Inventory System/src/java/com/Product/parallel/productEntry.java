...
public class productEntry {
    ...
    public String addProduct(long barcode, int volume, int numberOfBottles,String category, String brand, float price, String productName, int min_stock, int max_stock)
    {
        ...
        Query1 = "INSERT INTO p_stock(Barcode, Brand, Litres, NumberOfBottles, Price, Category, ProductName, Min_Stock, Max_stock)"
                + "VALUES (?,?,?,?,?,?,?,?,?)";
        
        Query2 = "INSERT INTO p_daily(Barcode, opening, closing, sales, Incoming)"
                + "VALUES (?,0,0,0,?)";
        
        //Query3 = "INSERT INTO p_daily(Barcode, opening, closing, sales, Incoming)"
               // + "VALUES (?,0,0,0,?)";
        
        Query4 = "INSERT INTO p_monthly(Barcode, opening, closing, sales, Incoming)"
                + "VALUES (?,0,0,0,?)";
