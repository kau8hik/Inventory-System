...
session.setMaxInactiveInterval(15*60);
  ...
  if(uname==null){
    session.setAttribute("from_page", "../for_parallel/pro_upd_post_admin.jsp");
                        ...
                        <br><br>
                         <%
                            try{
                                ...
                                String Query_p="update p_stock set category='"+category+"', brand='"+brand+"',productname='"+productname+"',litres='"+litres+"',price='"+price+"',min_stock='"+min_stock+"',max_stock='"+max_stock+"'  where barcode="+barcode;
                                                             //out.println(Query);

                                //psmt = con.prepareStatement(Query);
                                psmt1 = con.prepareStatement(Query_p);
                                //psmt.executeUpdate();
                                psmt1.executeUpdate();
