...
session.setMaxInactiveInterval(15*60);
  ...
  if(uname==null){
    session.setAttribute("from_page", "../for_parallel/productupdate_admin.jsp");
            ...
            <table width="100%" style="height:500px"   border="1">
                <tr>
                    ...
                    try{
                        ...
                        String Query="select * from p_stock where barcode="+barcode;
                        //out.println(Query);
                    ...
                    %>
                    <form action="pro_upd_post_admin.jsp" method="post">
