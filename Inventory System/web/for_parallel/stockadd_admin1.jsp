...
session.setMaxInactiveInterval(15*60);
  ...
  if(uname==null){
    session.setAttribute("from_page", "../for_parallel/stockadd_admin1.jsp");
	...
	<div id="topNav" class="list">
        ...
        <table width="100%"  border=1>
            ...
            <%
                ...
                out.write("setTimeout(function(){window.location.href='stockadd_admin.jsp'},1000);");
                out.write("</script>\n");
                //response.sendRedirect("stockadd_admin.jsp");
            %>
            <script>
                alert("Result:"+<%=value%>);
            </script>
