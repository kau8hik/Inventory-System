...
session.setAttribute("bill_id", 5);
  String uname= (String) session.getAttribute("uname");
  if(uname==null){
    session.setAttribute("from_page", "Bill5_admin.jsp");
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="topNav" class="list">
        ...
        Logged in as : <%=uname%>                                       Bill5                                              <a href="../logout.jsp">Logout</a></pre>
        <table width="100%"  border=1>
            <tr>
                <td rowspan="1" width="10%" height="222px"><pre><br>
                <form name="input" action="Bill5_admin.jsp" method="post" onsubmit="return validateForm();">
               ...
               <input type="submit" value="submit"/>
                ...
                try {
                        ...
                        if (a == null) {
                            ...
                            String query12 = "SELECT SUM( Litres ) AS t FROM temp_bill5";
                    ...
                    <%
                            ...
                            String Query_ret_temp = "Select * from temp_bill5 where barcode =" + id;
                            ...
                            if (category_ret_temp == null) {
                                String Query1 = "insert into temp_bill5 values(" + id + ",'" + Category + "','" + Brand + "','" + Product + "'," + Volume + "," + noofbottles + "," + Price + ","+ind_volume+","+ind_price+")";
                                psmt = con.prepareStatement(Query1);
                                psmt.execute();
                            }
                            else {
                                String Query1_update_tmp = "update temp_bill5 set price=price+" + ind_price + ",litres=litres+" + ind_volume + ",noofbottles=noofbottles+" + noofbottles + " where barcode=" + id;
                ...
                //out.println(Query1);
                //out.println(res1);
                String Query2 = "Select * from temp_bill5 ";
                //out.println(Query);
                //out.println(Query2);
                psmt3 = con.prepareStatement(Query2);
                res3 = psmt3.executeQuery();

                String Query_total = "SELECT sum( Price ) as t FROM temp_bill5";
