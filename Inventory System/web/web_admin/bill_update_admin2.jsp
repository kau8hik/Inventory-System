        ...
        <%
         ...
         try {
            ...
            if(noofbottles1.equals("0")){
               a  = "delete from temp_bill2 where barcode='"+barcode+"'";
               ...
               psmt.executeUpdate();
                        ...
                        a = "update temp_bill2 set noofbottles="+noofbottles+", price=price_bot*noofbottles, litres=net_qu*noofbottles where barcode ='"+barcode+"'" ;
