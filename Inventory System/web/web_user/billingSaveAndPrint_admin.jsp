...
<%
    ...
    switch(bill_id){
        ...
        case 4: table="temp_bill4";redir="Bill4_admin.jsp";break;
        case 5: table="temp_bill5";redir="Bill5_admin.jsp";break;
    }
        ...
        for(int ab=0;ab<100;ab++){
            if (billid[ab]!=0){
                ...
                if(chk==1){
                    ...
                    psmt = con.prepareStatement("INSERT INTO billingtable(Contents, TotalCost, Date, Billid, discount, after_discount) VALUES(?,?,now(),?,?,?)");
